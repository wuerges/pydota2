"""
Mappings of Dota2 objects from their unique IDs to their english names.

TODO:
    Allow user to override these constants e.g. for a different language 
    or styling. 

    Maybe add a function that'll take a text or json file.
"""
